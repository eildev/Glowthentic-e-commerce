...
console.log("sdf", shippingCharge);
  ...
  return (
    <div className="space-y-4">
      ...
      </div>
      {
        ...
        <span className="text-sm font-normal">Discount ({couponData ? (couponData.cupon_code) : ""})</span>
        <span className="text-sm font-medium">{discountPrice ? discountPrice : 0} <span>{discountPrice ? value : "৳"}</span></span>
      </div>
      }
      <div className="flex justify-between">
