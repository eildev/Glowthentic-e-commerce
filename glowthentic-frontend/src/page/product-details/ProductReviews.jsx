  ...
  return (
    <>
      <div className="mt-4 mb-[28px]">
        <h2 className="md:text-[18px] text-[10px] text-[#242424] border-b border-[#242424] w-fit p-[10px] mb-6">
          Rate & review ({reviews?.length ?? 0})
        </h2>
            ...
            <div key={index} className="mb-[27px]">
              <div className="flex gap-[18px]">
                <img
                  ...
                  className="md:w-[56px] w-[32px] object-cover md:h-[59px] h-[32px] rounded-full"
                />
                <div>
                  <div className="flex items-center md:gap-4 gap-2">
                    <h1 className="md:text-[18px] text-[10px] font-medium text-[#565656]">
                      {item.user.name}
                    </h1>
                    <Rating
                  ...
                  <p className="text-[#868686] md:text-[16.11px] text-[9px] mt-1">
                    {item.review}
                  </p>
                  <div className="flex flex-wrap gap-[18px] mt-[18px]">
                    ...
                    {/* {item.images?.map((image, i) => (
                      <img
                        className="md:w-[125px] w-[72px] md:h-[125px] h-[72px] border-2 duration-200 border-transparent hover:border-[#EF4A03]"
                        key={i}
                        src={image}
                        alt=""
                      />
