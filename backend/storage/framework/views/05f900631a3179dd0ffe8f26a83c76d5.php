                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="tpfooter__widget footer-col-1 mb-50">
                            ...
                            <p>If you have any questions, feel free to <a href="<?php echo e(route('contactus')); ?>">let us know.</a>
                        ...
                        <div class="tpfooter__widget footer-col-3 mb-50">
                            ...
                            <div class="tpfooter__widget-links">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('termsandcondition')); ?>">Terms & Conditions</a></li>
                                    <li><a href="<?php echo e(route('privacypolicy')); ?>">Privacy Policy</a></li>
                                    <li><a href="<?php echo e(route('aboutus')); ?>">Returns & Refunds</a></li>
                                    <li><a href="<?php echo e(route('faqs')); ?>">FAQ</a></li>
                                    <li><a href="<?php echo e(route('career')); ?>">Sobrokom Career</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tpfooter__widget footer-col-4 mb-50">
                            ...
                            <div class="tpfooter__widget-newsletter">
                                <p>Subscribe to the SOBROKOM.STORE mailing list to receive updates <br> on new arrivals
                                    ...
                                    other information.</p>
                                <form>
                                    <span><i><img src="<?php echo e(asset('frontend')); ?>/assets/img/shape/message-1.svg"
                                                alt=""></i></span>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            I accept <a style="color:#9e54a1" target="_blank"
                                                href="<?php echo e(route('termsandcondition')); ?>">terms & conditions & privacy
                                                policy.</a>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-7 col-sm-12">
                        <div class="tpfooter__copyright">
                            <span class="tpfooter__copyright-text">Copyright © <a
                                    href="<?php echo e(route('home')); ?>">SOBROKOM.STORE</a> all
...
<!-- footer-area-end -->
<?php /**PATH C:\Users\Eclipse\Desktop\office task\Glowthentic-e-commerce\backend\resources\views/frontend/body/footer.blade.php ENDPATH**/ ?>