...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="<?php echo e(asset('backend')); ?>/assets/images/logo.svg" type="image/png" />
    <!--plugins-->
...
<body>
    ...
    <div class="wrapper">
        ...
        <!--end sidebar wrapper -->
        <!--start header -->
        <?php echo $__env->make('backend.body.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--end header -->
        <!--start page wrapper -->
    ...
    <!--end wrapper-->
    <!--start switcher-->
    <?php echo $__env->make('backend.body.switcher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end switcher-->
    <!-- Bootstrap JS -->
    ...
    <script src="<?php echo e(asset('backend')); ?>/assets/plugins/input-tags/js/tagsinput.js"></script>
    ...
    <script src="<?php echo e(asset('backend')); ?>/assets/plugins/select2/js/select2.custom.js"></script>
    <script src="<?php echo e(asset('backend')); ?>/assets/js/validation2.min.js"></script>
...
<?php /**PATH E:\live Projects\Glowthentic\Glowthentic-e-commerce\backend\resources\views/backend/master.blade.php ENDPATH**/ ?>