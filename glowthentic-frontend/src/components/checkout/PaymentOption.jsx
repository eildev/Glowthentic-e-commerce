      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="flex flex-col items-center bg-white rounded shadow-md p-2">
            ...
            <input type="radio" id="cash" {...register("paymentMethod", { required: "Please select a payment method" })} value="cash" className="mt-2" />
          </div>
          ...
          <div className="flex flex-col items-center bg-white rounded shadow-md p-2">
            ...
            <input type="radio" id="mobile-banking" {...register("paymentMethod", { required: "Please select a payment method" })} value="mobile-banking" className="mt-2" />
          </div>
          ...
          <div className="flex flex-col items-center bg-white rounded shadow-md p-2">
            ...
            <input type="radio" id="card" {...register("paymentMethod", { required: "Please select a payment method" })} value="card" className="mt-2" />
          </div>
        </div>
