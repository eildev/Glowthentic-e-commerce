  ...
  return (
    <div className="px-2 w-full mx-auto">
      ...
      <div>
        ...
        {
        wishlist?.wishlist?.map((item, i)=>  <div key={i} className="flex items-center my-4 lg:my-8">
        <div className="w-5/12 lg:w-3/12 px-4 pt-4 bg-light relative">
          <img className="w-full object-cover" src={item?.variant.variant_image[0].image} alt="" />
