      ...
      {[...Array(2)].map((_, index) => (
        <div key={index} className="mb-[27px]">
          <div className="flex gap-[18px]">
            <div className="w-[56px] h-[59px] rounded-full bg-gray-300"></div>
            <div className="w-full">
              ...
              <div className="mt-1 h-4 w-full bg-gray-300 rounded"></div>
              ...
              <div className="flex flex-wrap gap-[18px] mt-[18px]">
                {[...Array(2)].map((_, i) => (
                  <div
                    key={i}
                    className="md:w-[125px] w-[72px] md:h-[125px] h-[72px] bg-gray-300 rounded-sm"
                  ></div>
                ))}
              </div>
            </div>
