...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Profile Header */}
      <div className="relative bg-white rounded-lg shadow-md overflow-hidden mb-6 animate-fadeIn">
        {/* Cover Image */}
      ...
      {/* Edit Profile Button */}
      <div className="flex justify-center sm:justify-start gap-3 animate-fadeIn">
        <Link
          to="edit"
