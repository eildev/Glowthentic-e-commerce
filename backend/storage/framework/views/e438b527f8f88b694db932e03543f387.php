...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('frontend')); ?>/assets/img/logo/favicon.svg">
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/animate.css">
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/swiper-bundle.css">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/spacing.css">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/icon-dukamarket.css">
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/main.css">
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/all.css">
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/assets/css/invoice.css">
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <!--    <img src="<?php echo e(asset('uploads/pageloader.gif')); ?>" style="width:112px;">-->
    <!--</div>-->
    ...
    <header>
        <?php echo $__env->make('frontend.body.topheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('frontend.body.mainnav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </header>
    <main>
        <div class="mobile-bottom-menu d-none justify-content-between align-items-center">
            ...
            <div class="bottom-button d-flex justify-content-around w-75">
                <a href="<?php echo e(route('home')); ?>" style="color: white">Home</a>
                <div style="height: 100%; width:1px; background:white;border:none">s</div>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(!empty(Auth::user()->id) ? route('user.dashboard') : route('login')); ?>"
                ...
                <div class="my_menu_inner">
                    <div class="my_menu_list">
                        <ul class="list-unstyled">
                            ...
                            <li class="first_li" id="first_li_<?php echo e($category->id); ?>"><a
                                    href="<?php echo e(route('category.wise.product', $category->slug)); ?>"><?php echo e($category->categoryName); ?></a>
                                <ul class="list-unstyled">
                                    <?php
                                    ...
                                    <?php if($subcategories->count() > 0): ?>
                                        <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="second_li" id="second_li_<?php echo e($subcategory->id); ?>"><a
                                                    href="<?php echo e(route('subcategory.wise.product', $subcategory->slug)); ?>"><?php echo e($subcategory->subcategoryName); ?></a>
                                                <?php
                                                ...
                                                <?php if($subSubcategories->count() > 0): ?>
                                                    <ul class="list-unstyled">
                                                        <?php $__currentLoopData = $subSubcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubcategorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="third_li"
                                                                id="third_li_<?php echo e($subSubcategorie->id); ?>"><a
                                                                    href="<?php echo e(route('sub.subcategory.wise.product', $subSubcategorie->slug)); ?>"><?php echo e($subSubcategorie->subSubcategoryName); ?></a>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                <?php endif; ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                            <li class="first_li"><a href="<?php echo e(route('order.tracking')); ?>">Order Tracking</a><li>
                            <hr>
    ...
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/jquery.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/waypoints.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/bootstrap.bundle.min.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/swiper-bundle.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/nice-select.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/slick.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/magnific-popup.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/counterup.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/wow.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/isotope-pkgd.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/imagesloaded-pkgd.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/countdown.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/ajax-form.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/meanmenu.js" defer></script>
    <script src="<?php echo e(asset('frontend')); ?>/assets/js/main.js" defer></script>
    <script src="<?php echo e(asset('js')); ?>/share.js" defer></script>
    <!-- Toastr -->
            ...
            if (Object.keys(cartData).length > 0) {
                ...
                for (var i = 0; i < itemsToDisplay; i++) {
                    ...
                    $('.cart_container').append(
                        ...
                        '<img src="<?php echo e(asset('uploads/products/')); ?>/' + item.options.image + '" alt="product Image">' +
        ...
        $(document).ready(function() {
            fetch('https://ipinfo.io/json')
                ...
                .then(data => {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('user.count')); ?>',
                        type: 'post',
                        data: {
    ...
    <?php if(!empty($order)): ?>
        <script>
            ...
            ?>
            let status = '<?php echo e($order->status); ?>';
            let date = '<?php echo e($formattedDate); ?>';
...
<?php /**PATH C:\Users\Eclipse\Desktop\office task\Glowthentic-e-commerce\backend\resources\views/frontend/master.blade.php ENDPATH**/ ?>