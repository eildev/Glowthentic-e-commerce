        ...
        <div className="bg-white p-0 ">
          ...
          {isDeleteActive && (
            ...
            >
              ...
              <div className="h-56 w-full bg-white px-3 py-5">
                <div className="">
                  <h1 className="text-[#1C1B1B] text-start">
                    Delete product from wishlist
                  </h1>
                </div>
                <button
                  onClick={() => handleDelete(getItemId)}
                  className="w-full bg-[#FA8232] bottom-0 rounded-lg p-2 text-white mt-8 transform"
                >
                  Delete product
                </button>
                <button
                  onClick={() => setIsDeleteActive(!isDeleteActive)}
                  className="w-full transform bg-white border border-[#F4F5FD] rounded-lg p-2 text-[#1C1B1B] mt-8"
                >
                  Cancel
                </button>
                {/* <button
