        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card border-top border-0 border-3 border-info">
                    <form action="<?php echo e(Route('offerbanner.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <div class="card-title d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="<?php echo e(route('offerbanner.view')); ?>" class="btn btn-info btn-sm text-light ">
...
unset($__errorArgs, $__bag); ?>" name="short_description" placeholder=""
...
unset($__errorArgs, $__bag); ?>"
                                            id="inputEnterYourName" value="<?php echo e(old('link')); ?>"
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\fardus-hassan\project_1\Glowthentic-e-commerce\backend\resources\views/backend/OfferBanner/insert.blade.php ENDPATH**/ ?>