        ...
        <div class="row">
            <div class="col">
                <div class="card radius-10 bg-gradient-ibiza">
                    <a href="<?php echo e(route('user-tracker.show')); ?>">
                        <div class="card-body">
                            <p class="mb-0 text-white pb-2"> Visitor </p>
                            <div class="d-flex align-items-center">
                                <h6 class="mb-0 text-white">Today</h6>
                                <div class="ms-auto">
                                    <h6 class="mb-0 text-white"> <?php echo e($visitorsToday); ?></h6>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center text-white">
                                ...
                                <h6 class="mb-0 ms-auto text-white"><?php echo e($visitors); ?></h6>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-deepblue">
                    <a href="<?php echo e(route('product.view')); ?>">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-white"><?php echo e($products); ?></h5>
                                <div class="ms-auto">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-orange">
                    <a href="<?php echo e(route('new.order')); ?>">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-white"><?php echo e($new_orders); ?></h5>
                                <div class="ms-auto">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ohhappiness">
                    <a href="<?php echo e(route('all.users')); ?>">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-white"><?php echo e($users); ?></h5>
                                <div class="ms-auto">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ibiza">
                    <a href="<?php echo e(route('order.refunded')); ?>">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-white"><?php echo e($refund ?? 0); ?></h5>
                                <div class="ms-auto">
                ...
                <div class="card radius-10 bg-gradient-ohhappiness">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <p class="mb-0 text-white">Total Order</p>
                            <div class="ms-auto">
                                <p class="mb-0 text-white"> <?php echo e($total_orders); ?> Nos</p>
                            </div>
                        </div>
                        ...
                        <table class="table" id="order_table">
                            ...
                            <tbody>
                                <tr>
                                    <td>New </td>
                                    <td><?php echo e($new_orders); ?></td>
                                    <td><a href="<?php echo e(route('new.order')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Confirm</td>
                                    <td><?php echo e($approve_orders); ?></td>
                                    <td><a href="<?php echo e(route('order.confirmed')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Proccess</td>
                                    <td><?php echo e($processing_orders); ?></td>
                                    <td><a href="<?php echo e(route('order.processed')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Delivery</td>
                                    <td><?php echo e($delivering_orders); ?></td>
                                    <td><a href="<?php echo e(route('order.delivering')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Completed</td>
                                    <td><?php echo e($completed_order); ?></td>
                                    <td><a href="<?php echo e(route('order.completed')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Refunding</td>
                                    <td><?php echo e($refunding_order); ?></td>
                                    <td><a href="<?php echo e(route('order.refunding')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Refunded</td>
                                    <td><?php echo e($refunded_order); ?></td>
                                    <td><a href="<?php echo e(route('order.refunded')); ?>">View Details</a></td>
                                </tr>
                                <tr>
                                    <td>Canceled</td>
                                    <td><?php echo e($canceled_order); ?></td>
                                    <td><a href="<?php echo e(route('order.canceled')); ?>">View Details</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card radius-10 bg-gradient-orange">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <p class="mb-0 text-white">Total Purchase </p>
                            <div class="ms-auto">
                                <p class="mb-0 text-white"> <?php echo e($purchases->count()); ?> </p>
                            </div>
                        </div>
                        <div class="progress my-3 bg-light-transparent" style="height:3px;">
                            <div class="progress-bar bg-white" role="progressbar" style="width: 100%" aria-valuenow="25"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(route('purchase.view')); ?>">View Details</a></td>
                                    </tr>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\live Projects\Glowthentic\Glowthentic-e-commerce\backend\resources\views/backend/dashboard.blade.php ENDPATH**/ ?>