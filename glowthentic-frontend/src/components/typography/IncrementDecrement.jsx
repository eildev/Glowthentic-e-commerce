...
const IncrementDecrement = ({ setItemCount, item, status, itemCount}) => {
  ...
  return (
   <>
    {status == "details" && <div className="inline-flex items-center space-x-2 border border-gray-thin p-2 rounded-lg">
      <span
    ...
    {status == "cart" && <div className="inline-flex items-center space-x-2 border border-gray-thin p-2 rounded-lg">
      <span
        className="cursor-pointer border-2 border-gray-bold rounded-md bg-gray-200 text-lg font-thin hover:bg-gray-300"
