...
unset($__errorArgs, $__bag); ?>"
                                            id="" value="<?php echo e(old('categoryName')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                            id="category_name" value="<?php echo e(old('categoryName')); ?>"
                                            placeholder="Enter Category Name">
                                        <?php $__errorArgs = ['categoryName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\live Projects\Glowthentic\Glowthentic-e-commerce\backend\resources\views/backend/category/insert.blade.php ENDPATH**/ ?>