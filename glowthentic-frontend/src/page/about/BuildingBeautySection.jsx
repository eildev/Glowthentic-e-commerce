...
const BuildingBeautySection = () => {
    return (
        ...
        // </div>
        <div className="mt-20 mb-20 relative grid grid-cols-1 lg:grid-cols-2 items-center md:items-start gap-32 md:justify-between p-6 md:p-2 max-w-5xl mx-auto overflow-hidden">
      {/* Image Section */}
