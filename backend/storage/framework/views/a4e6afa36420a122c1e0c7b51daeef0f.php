            ...
            <div class="card border-top border-0 border-3 border-info col-md-12">
                <div class="card-body">
                    <div class="card-title d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-info">Delivering order list</h5>
                        ...
                        <table id="order_table" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                    $serialNumber = 1;
                                ?>
                                <?php if($delivering_orders->count() > 0): ?>
                                    <?php $__currentLoopData = $delivering_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.completed.order',$order->invoice_number)); ?>" class="btn btn-sm btn-info">Complete</a>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\live Projects\Glowthentic\Glowthentic-e-commerce\backend\resources\views/backend/order/logistics.blade.php ENDPATH**/ ?>