...
import emptyCartImage from "../../assets/img/cart/emptyCart.png";
...
const CartPage = () => {
  ...
  return (
    <div
      className={`${filteredCartItems.length > 0 ? "lg:py-10" : "lg:pb-10"}`}
    >
      ...
      <Container>
        {filteredCartItems.length > 0 ? (
          ...
          <div className="block text-center text-lg font-semibold">
            ...
            <h2 className="font-bold text-xl lg:text-2xl text-secondary mb-3">
              Your cart is empty
            </h2>
            <Link
              to="/products"
              className="bg-secondary text-white px-5 py-2 w-1/5 mx-auto rounde-md flex gap-2 justify-center items-center"
            >
