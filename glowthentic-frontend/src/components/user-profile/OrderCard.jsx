  ...
  return (
    <>
      {status === "On Delivery" ? (
              ...
              <div key={i} className="border-b border-b-gray-light py-8">
                <div>
                  ...
                  <p className="flex capitalize justify-between items-center text-md md:text-lg text-dark font-semibold font-encode bg-hr-thin py-2 px-4 my-2">
                    ...
                    <Icon className="hidden w-4 h-4 md:w-6 md:h-6" icon="mdi-light:truck" />
                    <Icon className="hidden w-4 h-4 md:w-6 md:h-6" icon="mdi-light:check-circle" />
                  </p>
        ...
        <p className="text-center text-gray-500">আপনার কোনো অর্ডার ইতিহাস নেই।</p>
      ) : (
