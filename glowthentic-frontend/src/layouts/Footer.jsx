      ...
      <div className="bg-primary">
        <Container>
          <footer
            ...
            )} footer gap-4 text-base-content p-5`}
          >
            <nav>
              ...
              <fieldset className="form-control">
                ...
                <div className="flex  gap-2 w-full">
                  <input
                    ...
                    className="bg-transparent w-full border-b border-red-500 focus:outline-none p-2"
                  />
                  <button className="bg-transparent p-2 border">
                    Subscribe
                  </button>
                </div>
