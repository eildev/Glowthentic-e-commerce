...
const NewestUpdate = () => {
    ...
    return (
        ...
        <div >
              <div className='bg-[#FA8232] mt-24 px-2 mx-auto pt-20 h-[470px] mb-40 '>
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-[11px] placeholder:text-black border border-[#C3CAD9] rounded-lg text-black font-bold focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
         <button  className='bg-[#FA8232] mt-2  rounded-md absolute right-1 top-1 transform -translate-y-2'>
          <div>
          <h1 className='text-center px-8 py-2 text-white'>Subscribe</h1>
          </div>
      </button>
