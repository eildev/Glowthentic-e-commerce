  ...
  return (
    ...
    >
      <Container>
        {/* main menu  */}
        <ul
          className={`mt-5 transition-all duration-500 ease-in-out transform  ${menu
        ...
        >
          {category.map((element, index) => (
            <>
              <li key={index} className="bg-white py-2 px-5 border-t last:border-b border-gray-light font-semibold cursor-pointer">
                <Link
                  to="#"
