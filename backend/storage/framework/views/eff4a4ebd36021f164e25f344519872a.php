                        ...
                        <table id="order_table" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                    $serialNumber = 1;
                                ?>
                                <?php if($approved_orders->count() > 0): ?>
                                    <?php $__currentLoopData = $approved_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.process.order',$order->invoice_number)); ?>" class="btn btn-sm btn-info">Process</a>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\live Projects\Glowthentic\Glowthentic-e-commerce\backend\resources\views/backend/order/approved-order.blade.php ENDPATH**/ ?>