  ...
  return (
    <div>
      <Container>
            ...
            <fieldset className="form-control w-80">
              ...
              <div className="join">
                {/* <input
                  ...
                  className={twMerge} input input-bordered
                /> */}
        ...
        <footer className="footer grid md:grid-cols-2 lg:grid-cols-3 bg-neutral text-neutral-content items-center px-5 py-4">
      ...
      <Container>
        <footer className="footer bg-base-200 text-base-content border-base-300 border-t px-10 py-4 px-5">
          <aside className="grid-flow-col items-center">
            <p>© {new Date().getFullYear()} Glowthentic - All Rights Reserved.</p>
          </aside>
