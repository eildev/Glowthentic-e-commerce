        ...
        try {
            ...
            if (response.data) {
                if (
                    ...
                    toast.success(
                        `You Got ${discountValue}${response?.data?.discount_type === "percentage" ? "%" : "৳"
                        } Discount`
                    );
                    setCouponData(response.data);
                    setCoupon_code("");
    ...
    return (
        <>
            <div className="grid gap-5 h-fit animate-fadeIn">
                <div
                    className={`card bg-base-100 shadow-sm rounded-[5px] ${voucher ? "" : "hidden"
                        }`}
                >
                ...
                <button
                    ...
                    className={`text-sm text-[#FA8232] hover:text-[#c4723c] transition-all duration-100 underline text-left pl-2 hidden lg:block ${!voucher ? "" : "hidden"
                        }`}
                >
                    Have Any Voucher?
                </button>
                <div className="card bg-base-100 shadow-sm rounded-[5px]">
                    <div className="card-body">
                        ...
                        <div className="pb-3">
                            <ul className="flex justify-between">
                                <li className="text-lg lg:text-xl text-[#191C1F]">
                                    Total
                                </li>
            ...
            {voucherActive && (
                <VoucherCodeApplyInSmallDevice voucherActive={voucherActive} isVoucherActive={isVoucherActive} />
            )}
        </>
    );
};
