  ...
  return (
    <div className="p-4 animate-pulse">
      ...
      <div className="collapse collapse-arrow bg-white mb-2">
        <div className="collapse-title h-6 bg-gray rounded w-1/4"></div>
        <div className="collapse-content">
          <div className="px-4 py-2">
            {/* Slider */}
            <div className="h-2 bg-gray rounded w-full mb-4"></div>
            {/* Price Labels */}
        ...
        <div className="collapse-content">
          {Array.from({ length: 5 }).map((_, index) => (
            <div key={index} className="flex items-center py-2">
              <div className="h-4 w-4 bg-gray rounded mr-3"></div>
      ...
      {/* Clear All Button */}
      <div className="h-10 bg-gray rounded w-full"></div>
    </div>
  );
};
